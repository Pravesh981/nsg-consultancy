          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <div className="card-surface p-6 mb-6 relative overflow-hidden">
                ...
                <h3 className="text-lg font-semibold text-white mb-4">Delhi, India</h3>
                <div className="flex flex-col gap-2 text-sm text-text-secondary">
                  <div className="flex items-start gap-2">
                    ...
                    <span>Safdarjung Enclave<br />Delhi, Delhi 110029<br />India</span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span>+91 7827715657</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="text-text-muted flex-shrink-0">
                      <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" />
                    </svg>
                    <span className="text-accent">delhi@SNG.consultancy</span>
                  </div>
                </div>
              </div>
